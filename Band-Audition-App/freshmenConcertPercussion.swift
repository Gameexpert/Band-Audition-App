 ...
 */
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        {
            os_log("Unable to decode the name for a FPAudition object.", log: OSLog.default, type: .debug)
            return nil
        }
        ...
        self.init(first_name: first_name, last_name: last_name as! String, instrument: instrument as! String, comments: comments as! String, scale1_pitch: scale1_pitch, scale1_production: scale1_production, scale2_pitch: scale2_pitch, scale2_production: scale2_production, snare_rhythm: snare_rhythm, snare_tempo: snare_tempo, snare_dynamic: snare_dynamic, snare_production: snare_production, mallet_rhythm: mallet_rhythm, mallet_pitch: mallet_pitch, mallet_tempo: mallet_tempo, mallet_dynamic: mallet_dynamic, mallet_production: mallet_production, snareRead_rhythm: snareRead_rhythm, snareRead_production: snareRead_production, malletRead_rhythm: malletRead_rhythm, malletRead_pitch: malletRead_pitch, malletRead_production: malletRead_production, finalScore: finalScore)
    }
}
